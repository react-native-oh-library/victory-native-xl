...
| ------------ | ------------ | ------------------------------ | ------------- | ------------- |------------------------ | ------------- | ------------- |
| @react-native-ohos/victory-native-xl | ~41.18.0（开发中）    | [Github Releases](https://github.com/react-native-oh-library/victory-native-xl/releases) | [0.82.*](https://github.com/react-native-oh-library/victory-native-xl/tree/br_rnoh0.82) | 否 | API12+ | 41.20.2 | [Npm Address](https://www.npmjs.com/package/@react-native-ohos/victory-native-xl) |
...
| ref | 它接受一个ref对象 ，通过 ref 命令式访问图表内部的 Skia Canvas 和交互动作 | object   | no       | all      | yes                |
