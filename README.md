...
| ------------ | ------------ | ------------------------------ | ------------- | ------------- |------------------------ | ------------- | ------------- |
| @react-native-oh-tpl/victory-native-xl | ~41.1.0    | [Github Releases](https://github.com/react-native-oh-library/victory-native-xl/releases) | [0.72.*](https://github.com/react-native-oh-library/victory-native-xl/tree/br_rnoh0.72) | 否 | API12+ | 41.1.0 | [Npm Address](https://www.npmjs.com/package/@react-native-oh-tpl/victory-native-xl) |
